...
class MonteCarloResults:
    ...
    def generate_computational_analysis(self, output_dir='figures',
        ...
        for metric in ['ll_gap', 'iterations', 'function_evals', 'wall_times']:
            ...
            for sample_size in sample_sizes:
                ...
                for method in ['analytical', 'numerical']:
                    ...
                    if metric == 'll_gap':
                        data = infeas_data['log_likelihoods'] - method_data['log_likelihoods']
                    else:
        ...
        for sample_size in sample_sizes:
            ...
            for method in ['analytical', 'numerical']:
                method_data = self.results[(method, sample_size)]
                method_iter = method_data['iterations']
            ...
            ax2.axhline(y=1, color='black', linestyle='-', linewidth=1, alpha=0.8)
            ...
            for method in ['analytical', 'numerical']:
                method_data = self.results[(method, sample_size)]
                method_nfev = method_data['function_evals']
            ...
            for method in ['analytical', 'numerical']:
                method_data = self.results[(method, sample_size)]
                method_time = method_data['wall_times']
